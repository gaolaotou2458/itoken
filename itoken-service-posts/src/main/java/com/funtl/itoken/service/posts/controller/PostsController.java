...
public class PostsController {
     ...
     * @return
     */
    @ApiOperation(value = "新增或者保存文章接口")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tbPostsPostJson", value = "文章对象json", required = true, dataTypeClass = String.class, paramType = "json"),
            @ApiImplicitParam(name = "optsBy", value = "操作者", required = true, dataTypeClass = String.class, paramType = "usercode")
    })
